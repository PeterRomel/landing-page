# landing-page
A practice project to consolidate the learned CSS styles.

#Skills to demonstrate:

1- Creating a new public repository on github.
2- Clone the repository on my local machine.
3- A well organised file folder structure.
4- A good knowledge of the HTML tags I learned so far.
5- A good knowledge of the CSS styles I learned so far.
6- Do my best to commit my changes.
